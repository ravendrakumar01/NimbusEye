...
export const RAIL: RailSection[] = [
  ...
  },
  {
    ...
    to: "/reports",
    items: [
      { label: "Availability Summary", stub: true },
      { label: "Performance Report", stub: true },
      { label: "Health Trend", stub: true },
      { label: "Top N / Bottom N", stub: true },
      { label: "SLA Report", stub: true },
      { label: "Outage Report", to: "/outages" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "User & Alert Management", group: true },
      { label: "Configuration Profiles", group: true },
